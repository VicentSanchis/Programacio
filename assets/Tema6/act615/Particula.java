...
public class Particula {
  ...
  public Particula (int x, int y, int ample, int alt) {
    ...
    comptador ++;
    this.posicio = new PVector (aleatori (x, x+ample), aleatori (y, y+alt));
  ...
  public Particula (PVector pos, PVector dir, float velEsc, int gran) {
    ...
    this.setColor (r, r, b);      // mateix valor r i g → gris
  ...
  private void setDefaultValues () {
    ...
    // Establim el color de forma aleatòria
    // Color aleatori entre gris i blau
    int r = aleatori (80, 190);
    int b = aleatori (160, 255);
    this.setColor (r, r, b);       // R i G són el mateix valor per fer-ho gris
  ...
  public static Particula crearParticula (int x, int y, int ample, int alt) {
    Particula p = new Particula (x, y, ample, alt);
    return p;
  }
}
